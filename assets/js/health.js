 ...
 * @returns {import('./types.js').TimelineConflict[]}
 */
export function getTimelineConflicts(book) {
  /** @type {import('./types.js').TimelineConflict[]} */
  const out = [];
...
/**
 * @param {import('./types.js').NarrativeIssue[]} issues
 * @param {import('./types.js').TimelineConflict[]} timeline
 * @returns {number}
 */
...
/**
 * @param {import('./types.js').Book} book
 * @returns {import('./types.js').BookHealth}
 */
