  ...
  const editor =
    ...
    <div class="mt-8 p-4 rounded-xl border border-nl-border bg-nl-surface space-y-3">
      ...
      <div class="flex flex-wrap gap-2 items-center">
        ...
        <label class="flex items-center gap-1 text-xs text-nl-muted shrink-0"><span class="whitespace-nowrap">Fecha</span>
          <input type="date" lang="es" data-ev-date="${selected.id}" class="bg-nl-raised border border-nl-border rounded px-2 py-1.5 text-xs w-[140px]" title="DD/MM/AAAA (selector)" />
        </label>
