...
export const WRITING_GUIDE_ARTICLES = [
  ...
  },
  {
    ...
    body: `
      ...
      <p class="text-slate-300 leading-relaxed">En Narrative Lab puedes anotar el <strong class="text-slate-200">objetivo del capítulo</strong> en el campo dedicado para no perder el hilo.</p>
    `,
  },
  {
    id: 'scenes',
  ...
  },
  {
    ...
    body: `
      ...
      <p class="text-slate-300 leading-relaxed">La vista <strong class="text-slate-200">Actos</strong> de Narrative Lab te permite alinear capítulos con macro-bloques narrativos.</p>
    `,
  },
  {
    id: 'narrator',
  ...
  },
  {
    ...
    body: `
      ...
      <p class="text-slate-300 leading-relaxed">El panel lateral de Narrative Lab puede ayudarte a vigilar <strong class="text-slate-200">ritmo y repeticiones</strong> en la escena activa.</p>
    `,
  },
];
