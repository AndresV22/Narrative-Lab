...
/** @param {string} [role] @returns {import('../core/types.js').CharacterRole} */
export function normalizeCharacterRole(role) {
  if (typeof role === 'string' && ROLE_SET.has(/** @type {import('../core/types.js').CharacterRole} */ (role))) {
    return /** @type {import('../core/types.js').CharacterRole} */ (role);
  }
  return 'secundario';
}
