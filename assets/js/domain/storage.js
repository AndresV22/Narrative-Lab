...
/**
 * Cierra la conexión a IndexedDB y borra la base `narrative_lab_db`.
 * Cancela guardados pendientes. Tras esto, `loadWorkspace` / `saveWorkspace` volverán a abrir una base vacía.
 * @returns {Promise<void>}
 */
