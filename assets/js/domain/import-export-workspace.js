...
import { deepClone, uuid } from '../core/utils.js';

/** Nombre de la aplicación en metadatos de exportación */
export const APP_EXPORT_NAME = 'Rinconcito narrativo';
 ...
 * @param {import('../core/types.js').Workspace} base
 * @param {import('../core/types.js').Workspace} incoming
