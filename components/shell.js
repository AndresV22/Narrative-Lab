...
export function shellMarkup() {
  return `
    <header class="shrink-0 border-b border-nl-border bg-nl-surface/95 backdrop-blur z-20">
      <div class="flex items-center gap-4 px-4 py-3 max-w-[100vw]">
        ...
        <div class="flex-1 flex justify-center min-w-0">
          <button type="button" data-action="search" class="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-nl-border bg-nl-raised text-sm text-nl-muted hover:text-slate-200 max-w-md w-full justify-start">
    ...
    <div class="flex flex-1 min-h-0">
      <aside data-sidebar class="w-64 shrink-0 border-r border-nl-border bg-nl-surface flex flex-col nl-scroll overflow-y-auto"></aside>
      <main data-main class="flex-1 min-w-0 flex flex-col bg-nl-bg nl-scroll overflow-y-auto"></main>
      <aside data-right class="hidden lg:flex w-80 shrink-0 border-l border-nl-border bg-nl-surface flex-col nl-scroll overflow-y-auto"></aside>
    </div>
